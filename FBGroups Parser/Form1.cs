...
namespace FBGroups_Parser
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            WB.Navigate("https://www.facebook.com/profile.php?id=100009753484757&lst=100009753484757%3A100009753484757%3A1493384466&sk=groups");
            WB.DocumentCompleted += new WebBrowserDocumentCompletedEventHandler(WB_DocumentCompleted);
            while (WB.ReadyState != WebBrowserReadyState.Complete)
                Application.DoEvents();
            for (int i = 0; i < 30; i++)
        ...
        private void WB_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            foreach (HtmlElement he in WB.Document.GetElementsByTagName("div"))
                if (he.GetAttribute("classname") == "mbs fwb")
                    he.InnerText = "VODKA PIVO";
